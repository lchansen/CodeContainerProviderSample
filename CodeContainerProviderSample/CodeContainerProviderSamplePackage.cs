...
namespace CodeContainerProviderSample
{
    ...
    [ProvideCodeContainerProvider("SampleCodeContainerProvider", PackageGuidString, ImageCatalogGuidString, 1027, "#100", "#101", typeof(SampleCodeContainerProvider))]
    public sealed class CodeContainerProviderSamplePackage : AsyncPackage, IVsPackageExtensionProvider
    {
        /// <summary>
        /// CodeContainerProviderSamplePackage GUID string.
        /// </summary>
        public const string PackageGuidString = "1ae44829-0e3c-44fe-89ec-d6b4255094f6";
        ...
        object IVsPackageExtensionProvider.CreateExtensionInstance(ref Guid extensionPoint, ref Guid instance)
        {
            ...
            {
                return new SampleCodeContainerProvider();
            }
